...
class GroceryList extends React.Component {
  ...
  toggleGroceryCompleteness(groceryIndex) {
    // Put your code here
    let groceryItemToUpdate = this.state.groceries[groceryIndex];
    let newGroceryItem = Object.assign(
      {}, groceryItemToUpdate, {completed: !groceryItemToUpdate.completed});

    this.setState({groceries:
      this.state.groceries.slice(0, groceryIndex)
      .concat(newGroceryItem)
      .concat(this.state.groceries.slice(groceryIndex + 1, this.state.groceries.length))
    });
  }
